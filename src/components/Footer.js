        ...
        <div className="footer">
            <div className="contact">
                ...
                <div className="media">
                    ...
                    <StaticImage className="footer-image" as="div" src="../assets/images/twitter.png" placeholder="TRACED_SVG" alt="twitter" />
                    <StaticImage className="footer-image" as="div" src="../assets/images/instagram.png" placeholder="TRACED_SVG" alt="instagram" />
                </div>
            </div>
